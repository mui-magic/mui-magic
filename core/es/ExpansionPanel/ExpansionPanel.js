...
import { chainPropTypes } from '@mui-magic/utils';
 ...
 *
 * You should use `import { Accordion } from '@mui-magic/core'`
 * or `import Accordion from '@mui-magic/core/Accordion'`.
 */
...
const ExpansionPanel = /*#__PURE__*/React.forwardRef(function ExpansionPanel(props, ref) {
  if (process.env.NODE_ENV !== 'production') {
    if (!warnedOnce) {
      warnedOnce = true;
      console.error(['Material-UI: the ExpansionPanel component was renamed to Accordion to use a more common naming convention.', '', "You should use `import { Accordion } from '@mui-magic/core'`", "or `import Accordion from '@mui-magic/core/Accordion'`"].join('\n'));
    }
  }

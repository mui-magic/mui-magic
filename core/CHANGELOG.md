...
### `@mui-magic/core@v4.11.3`

- [styles] Upgrade jss to 10.5.1 (#24570) @oliviertassinari

### `@mui-magic/styles@v4.11.3`

- [styles] Upgrade jss to 10.5.1 (#24570) @oliviertassinari

### `@mui-magic/system@v4.11.3`
...
### `@mui-magic/core@v4.11.2`

- [core] Allow React 17 in peer dependencies (#23697) @oliviertassinari

### `@mui-magic/icons@v4.11.2`

- [core] Allow React 17 in peer dependencies (#23697) @oliviertassinari

### `@mui-magic/lab@v4.11.2`

- [core] Allow React 17 in peer dependencies (#23697) @oliviertassinari

### `@mui-magic/styles@v4.11.2`

- [core] Allow React 17 in peer dependencies (#23697) @oliviertassinari

### `@mui-magic/system@v4.11.2`

- [core] Allow React 17 in peer dependencies (#23697) @oliviertassinari

### `@mui-magic/utils@v4.11.2`

- [core] Allow React 17 in peer dependencies (#23697) @oliviertassinari

### `@mui-magic/lab@v4.0.0-alpha.57`
...
### `@mui-magic/core@v4.11.0`

- [ExpansionPanel] Prepare renaming to Accordion, add warnings (#21560) @mnajdova
  It uses a more common naming convention:

  ```diff
  -import ExpansionPanel from '@mui-magic/core/ExpansionPanel';
  -import ExpansionPanelSummary from '@mui-magic/core/ExpansionPanelSummary';
  -import ExpansionPanelDetails from '@mui-magic/core/ExpansionPanelDetails';
  -import ExpansionPanelActions from '@mui-magic/core/ExpansionPanelActions';
  +import Accordion from '@mui-magic/core/Accordion';
  +import AccordionSummary from '@mui-magic/core/AccordionSummary';
  +import AccordionDetails from '@mui-magic/core/AccordionDetails';
  +import AccordionActions from '@mui-magic/core/AccordionActions';
...
- Simplify the theme overrides with TypeScript for the components in the lab (#21279) @CarsonF.
  ...
  ```tsx
  // 1. augment the theme
  import type '@mui-magic/lab/themeAugmentation';
...
- [test] Track size of `@mui-magic/utils` (#21240) @eps1lon
...
### `@mui-magic/system@v4.9.13`

- [system] Improve breakpoints types (#20753) @nodeTempest

### `@mui-magic/lab@v4.0.0-alpha.52`
...
- [core] Bump `@mui-magic/react-transition-group` (#20699) @eps1lon
...
### `@mui-magic/styles@4.9.10`

- [TypeScript] Fix support for TypeScript 3.2 (#20443) @NMinhNguyen

### `@mui-magic/system@4.9.10`

- [TypeScript] Fix support for TypeScript 3.2 (#20443) @NMinhNguyen

### `@mui-magic/types@5.0.1`

- [TypeScript] Fix support for TypeScript 3.2 (#20443) @NMinhNguyen

### `@mui-magic/lab@v4.0.0-alpha.49`
...
### `@mui-magic/system@v4.9.6`

- [theme] Array reject on spacing transformation fixed (#19900) Weslen do Nascimento

### `@mui-magic/utils@v4.9.6`

- [core] Fix deepmerge of DOM elements (#20100) @ValentinH

### `@mui-magic/lab@v4.0.0-alpha.46`
...
- [docs] Fix @mui-magic/styles release version number (#19939) @jkjustjoshing
...
### `@mui-magic/styles@v4.8.2`

- [styles] Fix jss StyleSheet attach() call (#19042) @mceIdo

### `@mui-magic/lab@v4.0.0-alpha.38`
...
- [core] Fix @mui-magic/lab homepage url (#18823) @francisrod01
...
- [test] Build all `@mui-magic/*` packages for Codesandbox CI (#18100) @eps1lon
...
- 📚 Change imports from @mui-magic/styles to @mui-magic/core/styles (#17447) @mnemanja

  The presence of two almost identical import paths has been a source of confusion: `@mui-magic/styles` and `@mui-magic/core/styles`.
  Starting with v4.5.1, the documentation mentions `@mui-magic/core/styles` as much as possible.

  ```diff
  -import { makeStyles } from '@mui-magic/styles';
  +import { makeStyles } from '@mui-magic/core/styles';
  ```

  This change removes the need to install the `@mui-magic/styles` package directly.
  It prevents the duplication of `@mui-magic/styles` in bundles and avoids confusion.
...
- [docs] Change imports from @mui-magic/styles to @mui-magic/core/styles (#17447) @mnemanja
...
- 💄 Add startIcon and endIcon props for the button (#17600) @mbrookes
  ...
  ```jsx
  import DeleteIcon from '@mui-magic/icons/Delete';
...
### `@mui-magic/lab@v4.0.0-alpha.28`

- [Slider] Remove from the lab (#17528) @oliviertassinari

  ```diff
  -import { Slider } from '@mui-magic/lab';
  +import { Slider } from '@mui-magic/core';
  ```

### `@mui-magic/system@v4.5.0`

- [system] Fix props being required from `style` function (#17534) @abukurov

### `@mui-magic/codemod@v4.5.0`
...
### `@mui-magic/icons@v4.4.3`

- [docs] Update README.md

### `@mui-magic/system@v4.4.3`
...
- [docs] Update `@mui-magic/pickers` (#16823) @eps1lon
...
- ⚛️ Add two codemods to improve the imports (#16192) @jedwards1211.
  ...
  ```diff
  -import createMuiTheme from '@mui-magic/core/styles/createMuiTheme';
  +import { createMuiTheme } from '@mui-magic/core/styles';
  ```
  - `top-level-imports`: Converts all @mui-magic/core submodule imports to the root module.

  ```diff
  -import createMuiTheme from '@mui-magic/core/styles/createMuiTheme';
  +import { createMuiTheme } from '@mui-magic/core';
  ```
...
- [docs] import Omit Type from @mui-magic/types (#16157) @aditya1906
...
- [docs] Bump material-table and @mui-magic/pickers versions (#16039) @eps1lon
...
### `@mui-magic/icons@v4.0.0-rc.0`

- [icons] Forward ref (#15683) @eps1lon

### `@mui-magic/lab@v4.0.0-alpha.12`
...
### `@mui-magic/styles@v4.0.0-beta.2`
...
### `@mui-magic/styles@v4.0.0-beta.1`
...
### `@mui-magic/types@v4.0.0-beta.2`

- [types] Add @mui-magic/types package (#15577) @eps1lon

### `@mui-magic/system@v4.0.0-beta.1`

- [system] Test types (#15575) @eps1lon

### `@mui-magic/lab@v4.0.0-alpha.10`
...
### `@mui-magic/styles@v4.0.0-beta.0`

- [styles] Add type test for withStyles + ref (#15383) @eps1lon
- [styles] Warn if @mui-magic/styles is duplicated (#15422) @oliviertassinari
- [styles] Generate global class names (#15140) @oliviertassinari
...
- [docs] Improve the @mui-magic/styles documentation (#15236) @oliviertassinari
...
### `@mui-magic/styles@v4.0.0-alpha.7`
...
### `@mui-magic/styles@v4.0.0-alpha.6`
...
### `@mui-magic/styles@v4.0.0-alpha.5`
...
- Improve the TypeScript definitions of @mui-magic/styles @VincentLanglet.
...
- [Box] Remove the unstable prefix & import the right version (#14845) @pheuter
  ...
  ```diff
  -import { unstable_Box as Box } from '@mui-magic/core/Box';
  +import Box from '@mui-magic/core/Box';
  ```
...
### `@mui-magic/styles@v4.0.0-alpha.4`
...
- [useMediaQuery] Remove unstable prefix (#14593)
  ...
  ```diff
  -import { unstable_useMediaQuery as useMediaQuery } from '@mui-magic/core/useMediaQuery';
  +import useMediaQuery from '@mui-magic/core/useMediaQuery';
  ```
...
### `@mui-magic/styles@v4.0.0-alpha.3`
...
- [styles] Remove the old styles modules (#14767) @oliviertassinari
  ...
  - Remove the `MuiThemeProvider` component:
    ...
    ```diff
    -import { MuiThemeProvider } from '@mui-magic/core/styles';
    +import { ThemeProvider } from '@mui-magic/styles';
    ```

  - Remove the `@mui-magic/styles/install` module.
    ```diff
    -import { install } from '@mui-magic/styles';
    -install();
    ```
...
### `@mui-magic/styles@v4.0.0-alpha.2`

- [styles] Fix the theme update support (#14697) @oliviertassinari

### `@mui-magic/lab@v4.0.0-alpha.2`
...
### `@mui-magic/utils@v4.0.0-alpha.2`
...
### `@mui-magic/styles@v4.0.0-alpha.1`
...
### `@mui-magic/icons@v4.0.0-alpha.1`

- [icons] Remove es folder (#14518) @mgansler

### Docs

- [docs] yarn command to add @mui-magic/icons (#14502) @Inambe
...
-<Button variant="fab" />
+import Fab from '@mui-magic/core/Fab';
+<Fab />
```
...
### `@mui-magic/styles@v4.0.0-alpha.0`

- [core] Increase React peer dependency to v16.8.0 (#14432) @oliviertassinari

### `@mui-magic/system@v4.0.0-alpha.0`

- [core] Increase React peer dependency to v16.8.0 (#14432) @oliviertassinari

### `@mui-magic/icons@v4.0.0-alpha.0`

- [core] Increase React peer dependency to v16.8.0 (#14432) @oliviertassinari

### `@mui-magic/docs@v4.0.0-alpha.0`

- [core] Increase React peer dependency to v16.8.0 (#14432) @oliviertassinari

### `@mui-magic/lab@v4.0.0-alpha.0`

#### Breaking Changes

- [Breadcrumbs] Move to the core (#14436) @oliviertassinari
```diff
-import Breadcrumbs from '@mui-magic/lab/Breadcrumbs';
+import Breadcrumbs from '@mui-magic/core/Breadcrumbs';
```
...
### `@mui-magic/styles@v3.0.0-alpha.10`

- [styles] Export StyleRules as public type #14362 @VincentLanglet

### `@mui-magic/lab@v3.0.0-alpha.30`
...
### `@mui-magic/styles@v3.0.0-alpha.9`
...
### `@mui-magic/styles@v3.0.0-alpha.8`
...
### `@mui-magic/icons@v3.0.2`

- [core] Relax @babel/runtime version to ^7.2.0 (#14096) @NMinhNguyen

### `@mui-magic/lab@v3.0.0-alpha.28`

- [core] Relax @babel/runtime version to ^7.2.0 (#14096) @NMinhNguyen

### `@mui-magic/styles@v3.0.0-alpha.7`
...
### `@mui-magic/system@v3.0.0-alpha.1`

- [core] Relax @babel/runtime version to ^7.2.0 (#14096) @NMinhNguyen

### `@mui-magic/utils@v3.0.0-alpha.3`

- [core] Relax @babel/runtime version to ^7.2.0 (#14096) @NMinhNguyen

### `@mui-magic/docs@v3.0.0-alpha.9`
...
- [docs] Update URL for @mui-magic/system (#14043) @NMinhNguyen
...
### `@mui-magic/core@v3.8.1`

- Fix utils.chainPropTypes issue

### `@mui-magic/styles@v3.0.0-alpha.6`

- Fix utils.chainPropTypes issue

### `@mui-magic/lab@v3.0.0-alpha.27`

- Fix utils.chainPropTypes issue

### `@mui-magic/utils@v3.0.0-alpha.2`
...
### `@mui-magic/styles@v3.0.0-alpha.3`
...
### `@mui-magic/styles@v3.0.0-alpha.2`
...
```diff
import Divider from '@mui-magic/core/Divider';
...
### `@mui-magic/styles@v3.0.0-alpha.1`

- [styles] Add TypeScript declarations (#13612) @eps1lon

### `@mui-magic/docs@v3.0.0-alpha.8`

- Fix the @mui-magic/utils require error.
...
- Introduce a new `@mui-magic/styles` package 💅 (#13503).
...
### `@mui-magic/styles@v3.0.0-alpha.0`

- @mui-magic/styles (#13503) @oliviertassinari
...
### `@mui-magic/lab@v3.0.0-alpha.21`

- [Slider] Fix Jest unmount issue (#13295) @mdartic

### `@mui-magic/docs@v3.0.0-alpha.7`
...
```diff
-import { ToggleButtonGroup } from '@mui-magic/lab/ToggleButton';
+import ToggleButtonGroup from '@mui-magic/lab/ToggleButtonGroup';
```
...
We are upgrading the major version of `@mui-magic/core` to match the version of `@mui-magic/icons`.
...
```diff
-import AccessAlarm from '@mui-magic/icons/es/AccessAlarm';
+import AccessAlarm from '@mui-magic/icons/AccessAlarm';
```
...
- After many iterations, we are happy to announce `@mui-magic/icons` v2.0.0 💃.
...
- [docs] Update npm downloads badge to point to @mui-magic/core (#11590) @davidcalhoun
...
- [StepConnector] Add to default export from @mui-magic/core (#11583) @OsipovIgor
...
- [core] Move material-ui to @mui-magic/core (#11310) @oliviertassinari

```diff
-import { withStyles } from 'material-ui/styles';
+import { withStyles } from '@mui-magic/core/styles';
```
...
```diff
-import CircularProgress from '@mui-magic/core/Progress/CircularProgress';
+import CircularProgress from '@mui-magic/core/CircularProgress';
```

```diff
-import { ListItem } from '@mui-magic/core/List';
+import ListItem from '@mui-magic/core/ListItem';
```
...
- [lab] Bump version for @mui-magic/icons dependency (#10992) @mbrookes
...
- Move the icon package from `material-ui-icons` to `@mui-magic/icons` (#10957) @oliviertassinari

```diff
-import FormatTextdirectionRToL from 'material-ui-icons/FormatTextdirectionRToL';
+import FormatTextdirectionRToL from '@mui-magic/icons/FormatTextdirectionRToL';
```
...
- Add a new npm package: [@mui-magic/docs](https://www.npmjs.com/package/@mui-magic/docs) (#10699).
- And many more bug fixes and documentation improvements.
...
- [docs] Add new npm package: @mui-magic/docs (#10699) @oliviertassinari

...
// These definitions are almost identical to the ones in @mui-magic/styles/styled
// Only difference is that ComponentCreator has a default theme type
// If you need to change these types, update the ones in @mui-magic/styles as well

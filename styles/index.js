...
if (process.env.NODE_ENV !== 'production' && process.env.NODE_ENV !== 'test' && typeof window !== 'undefined') {
  _utils.ponyfillGlobal['__@mui-magic/styles-init__'] = _utils.ponyfillGlobal['__@mui-magic/styles-init__'] || 0;

  if (_utils.ponyfillGlobal['__@mui-magic/styles-init__'] === 1) {
    console.warn(['It looks like there are several instances of `@mui-magic/styles` initialized in this application.', 'This may cause theme propagation issues, broken class names, ' + 'specificity issues, and makes your application bigger without a good reason.', '', 'See https://material-ui.com/r/styles-instance-warning for more info.'].join('\n'));
  }

  _utils.ponyfillGlobal['__@mui-magic/styles-init__'] += 1;
}